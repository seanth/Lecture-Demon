...
#import sox #python3 -m pip install sox
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ambientIn', metavar='', dest='theAmbientDirIn', default='input/raw_audio/ambient', required=False, help='path to folder containing mp3s' )
